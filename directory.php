...
try {
	...
	switch ($_GET['view']) {
		case '':
			// page header
			page_header($system['system_title'].' - '.__("Directory"), __($system['system_description_directory']));
			break;

		case 'users':
			// page header
			page_header($system['system_title'].' - '.__("Users Directory"), __($system['system_description_directory']));
		...
		case 'posts':
			// page header
			page_header($system['system_title'].' - '.__("Posts Directory"), __($system['system_description_directory']));
		...
		case 'pages':
			...
			// page header
			page_header($system['system_title'].' - '.__("Pages Directory"), __($system['system_description_directory']));
		...
		case 'events':
			...
			// page header
			page_header($system['system_title'].' - '.__("Events Directory"), __($system['system_description_directory']));
		...
		case 'games':
			...
			// page header
			page_header($system['system_title'].' - '.__("Games Directory"), __($system['system_description_directory']));
