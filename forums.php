...
try {
	...
	switch ($_GET['view']) {
		case '':
			// page header
			page_header($system['system_title'].' - '.__("Forums"), __($system['system_description_forums']));
		...
		case 'new-thread':
			...
			// page header
			page_header(__("Forums")." &rsaquo; ".__("Write New Thread"), __($system['system_description_forums']));
		...
		case 'edit-thread':
			...
			// page header
			page_header(__("Forums")." &rsaquo; ".__("Edit Thread"), __($system['system_description_forums']));
		...
		case 'new-reply':
			...
			// page header
			page_header(__("Forums")." &rsaquo; ".__("Post Reply"), __($system['system_description_forums']));
		...
		case 'edit-reply':
			...
			// page header
			page_header(__("Forums")." &rsaquo; ".__("Edit Reply"), __($system['system_description_forums']));
		...
		case 'my-threads':
			...
			// page header
			page_header(__("Forums")." &rsaquo; ".__("My Threads"), __($system['system_description_forums']));
		...
		case 'my-replies':
			...
			// page header
			page_header(__("Forums")." &rsaquo; ".__("My Replies"), __($system['system_description_forums']));
		...
		case 'search':
			// page header
			page_header(__("Forums")." &rsaquo; ".__("Search"), __($system['system_description_forums']));
		...
		case 'search-results':
			// page header
			page_header(__("Forums")." &rsaquo; ".__("Search Results"), __($system['system_description_forums']));
