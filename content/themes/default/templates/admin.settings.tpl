                ...
                <div class="form-group form-row">
                    ...
                    <div class="col-md-9">
                        <select class="form-control selectpicker" name="stories_permission">
                            <option value="admins" {if $system['stories_permission'] == "admins"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-lock fa-lg fa-fw'></i></div><div class='text'><b>{__("Admins")}</b><br>{__("Only Admins and Moderators")}</div></div>">{__("Admins")}</option>
                            <option value="pro" {if $system['stories_permission'] == "pro"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-rocket fa-lg fa-fw'></i></div><div class='text'><b>{__("Pro Users")}</b><br>{__("Only Admins, Moderators and Pro Users")}</div></div>">{__("Pro Users")}</option>
                            <option value="verified" {if $system['stories_permission'] == "verified"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-check-circle fa-lg fa-fw'></i></div><div class='text'><b>{__("Verified Users")}</b><br>{__("Only Admins, Moderators, Pro and Verified Users")}</div></div>">{__("Verified Users")}</option>
                            <option value="everyone" {if $system['stories_permission'] == "everyone"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-globe fa-lg fa-fw'></i></div><div class='text'><b>{__("Everyone")}</b><br>{__("Any user in the system can")}</div></div>">{__("Everyone")}</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group form-row">
                    ...
                    <div class="col-md-9">
                        <select class="form-control selectpicker" name="newsfeed_source">
                            <option value="default" {if $system['newsfeed_source'] == "default"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-users fa-lg fa-fw'></i></div><div class='text'><b>{__("Default")}</b><br>{__("Show what user is followings (Friends, Followings, Pages... etc)")}</div></div>">{__("Default")}</option>
                            <option value="all_posts" {if $system['newsfeed_source'] == "all_posts"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-globe fa-lg fa-fw'></i></div><div class='text'><b>{__("All Posts")}</b><br>{__("All posts will be shown")}</div></div>">{__("All Posts")}</option>
                        </select>
                        <span class="form-text">
                        ...
                        <div class="form-group form-row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control selectpicker" name="invitation_permission">
                                    <option value="admins" {if $system['invitation_permission'] == "admins"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-lock fa-lg fa-fw'></i></div><div class='text'><b>{__("Admins")}</b><br>{__("Only Admins and Moderators")}</div></div>">{__("Admins")}</option>
                                    <option value="pro" {if $system['invitation_permission'] == "pro"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-rocket fa-lg fa-fw'></i></div><div class='text'><b>{__("Pro Users")}</b><br>{__("Only Admins, Moderators and Pro Users")}</div></div>">{__("Pro Users")}</option>
                                    <option value="verified" {if $system['invitation_permission'] == "verified"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-check-circle fa-lg fa-fw'></i></div><div class='text'><b>{__("Verified Users")}</b><br>{__("Only Admins, Moderators, Pro and Verified Users")}</div></div>">{__("Verified Users")}</option>
                                    <option value="everyone" {if $system['invitation_permission'] == "everyone"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-globe fa-lg fa-fw'></i></div><div class='text'><b>{__("Everyone")}</b><br>{__("Any user in the system can")}</div></div>">{__("Everyone")}</option>
                                </select>
                            </div>
                        </div>
                ...
                <form class="js_ajax-forms" data-url="admin/settings.php?edit=accounts">
                    <div class="card-body">
                        ...
                        <div class="form-table-row">
                            ...
                            <div>
                                <div class="form-control-label h6">{__("Find People by Location")}</div>
                                <div class="form-text d-none d-sm-block">{__("If disabled find new people and people may know will be selected randomly")}</div>
                            </div>
                            <div class="text-right">
                ...
                <div class="form-group form-row">
                    ...
                    <div class="col-md-9">
                        <select class="form-control selectpicker" name="audio_call_permission">
                            <option value="admins" {if $system['audio_call_permission'] == "admins"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-lock fa-lg fa-fw'></i></div><div class='text'><b>{__("Admins")}</b><br>{__("Only Admins and Moderators")}</div></div>">{__("Admins")}</option>
                            <option value="pro" {if $system['audio_call_permission'] == "pro"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-rocket fa-lg fa-fw'></i></div><div class='text'><b>{__("Pro Users")}</b><br>{__("Only Admins, Moderators and Pro Users")}</div></div>">{__("Pro Users")}</option>
                            <option value="verified" {if $system['audio_call_permission'] == "verified"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-check-circle fa-lg fa-fw'></i></div><div class='text'><b>{__("Verified Users")}</b><br>{__("Only Admins, Moderators, Pro and Verified Users")}</div></div>">{__("Verified Users")}</option>
                            <option value="everyone" {if $system['audio_call_permission'] == "everyone"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-globe fa-lg fa-fw'></i></div><div class='text'><b>{__("Everyone")}</b><br>{__("Any user in the system can")}</div></div>">{__("Everyone")}</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group form-row">
                    ...
                    <div class="col-md-9">
                        <select class="form-control selectpicker" name="video_call_permission">
                            <option value="admins" {if $system['video_call_permission'] == "admins"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-lock fa-lg fa-fw'></i></div><div class='text'><b>{__("Admins")}</b><br>{__("Only Admins and Moderators")}</div></div>">{__("Admins")}</option>
                            <option value="pro" {if $system['video_call_permission'] == "pro"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-rocket fa-lg fa-fw'></i></div><div class='text'><b>{__("Pro Users")}</b><br>{__("Only Admins, Moderators and Pro Users")}</div></div>">{__("Pro Users")}</option>
                            <option value="verified" {if $system['video_call_permission'] == "verified"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-check-circle fa-lg fa-fw'></i></div><div class='text'><b>{__("Verified Users")}</b><br>{__("Only Admins, Moderators, Pro and Verified Users")}</div></div>">{__("Verified Users")}</option>
                            <option value="everyone" {if $system['video_call_permission'] == "everyone"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-globe fa-lg fa-fw'></i></div><div class='text'><b>{__("Everyone")}</b><br>{__("Any user in the system can")}</div></div>">{__("Everyone")}</option>
                        </select>
                    </div>
                </div>
            ...
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#Paystack" data-toggle="tab">
                        {include file='__svg_icons.tpl' icon="paystack" width="20px" height="20px" class="mr5"}<strong class="pr5">{__("Paystack")}</strong>
                    </a>
                </li>
                <li class="nav-item">
