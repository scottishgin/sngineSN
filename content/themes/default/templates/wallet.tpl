                ...
                <div class="card mt20">
                    ...
                    <div class="card-body">
                        ...
                        {if $wallet_withdraw_funding_amount}
                            <div class="alert alert-success mb20">
                                <i class="fas fa-check-circle mr5"></i>
                                {__("Congratulation! Your wallet credit replenished successfully with")} <span class="badge badge-pill badge-lg badge-light">{$system['system_currency_symbol']}{$wallet_withdraw_funding_amount|number_format:2}</span> {__("from your funding credit")}
                            </div>
                        {/if}
                            ...
                            <div class="form-group form-row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <span class="form-text">
                                        {__("The minimum withdrawal request amount is")} {$system['system_currency_symbol']}{$system['wallet_min_withdrawal']}
                                    </span>
                                </div>
                            </div>
