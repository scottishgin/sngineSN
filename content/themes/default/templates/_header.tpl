                                            ...
                                            <li class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    {if $system['points_enabled'] || $system['wallet_enabled'] || $user->_data['can_raise_funding']}
                                                        ...
                                                        {/if}
                                                        {if $user->_data['can_raise_funding']}
                                                            <a class="dropdown-item" href="{$system['system_url']}/settings/funding">{__("Funding")}: <span class="badge badge-success">{$system['system_currency_symbol']}{$user->_data['user_funding_balance']|number_format:2}</span></a>
                                                        {/if}
