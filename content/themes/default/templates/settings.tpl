        ...
        <div class="col-md-8 col-lg-9 offcanvas-mainbar">
            <div class="card">
                ...
                {elseif $view == "invitations"}
                    <div class="card-header with-icon">
                        <i class="fa fa-handshake mr10" style="color: #2196f3;"></i>{__("Invitations")}
                    ...
                    <div class="card-body">
                        <div class="alert alert-primary">
                            ...
                            <div class="text">
                                ...
                                {__("You have")} <strong><span class="badge badge-pill badge-danger">{if $system['invitation_user_limit'] == 0}{__("Unlimited")}{else}{$system['invitation_user_limit']}{/if}</span></strong> {__("invitations")} {if $system['invitation_user_limit'] != 0}{__("every")} {__($system['invitation_expire_period']|ucfirst)}{/if}
                                <br>
                            </div>
                        </div>
                        ...
                        <div class="section-title mb20">
                            <i class="fa fa-mail-bulk mr10"></i>{__("Your Invitations Codes")}
                        </div>
                        {if $invitation_codes}
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        {foreach $invitation_codes as $invitation_code}
                                            <tr>
                                                <td><span class="badge badge-pill badge-lg badge-light">{$invitation_code['code']}</span></td>
                                                <td>{$invitation_code['created_date']|date_format:"%e %B %Y"}</td>
                                                <td>
                                                    {if $invitation_code['used']}
                                                        <span class="badge badge-pill badge-lg badge-danger">{__("Yes")}</span>
                                                    {else}
                                                        <span class="badge badge-pill badge-lg badge-success">{__("No")}</span>
                                                    {/if}
                                                </td>
                                                <td>
                                                    {if $invitation_code['used']}
                                                ...
                                                <td>
                                                    {if !$invitation_code['used']}
                                                        <div class="d-inline-block" data-toggle="tooltip" data-placement="top" title='{__("Share")}'>
                    ...
                    <div class="card-body">
                        {if $sub_view == ""}
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-sm-6">
                                    <div class="section-title mb20">
                                        <i class="fas fa-donate mr10"></i>{__("Your Affiliate Balance")}
                                    </div>
                    ...
                    <div class="card-body">
                        {if $sub_view == ""}
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="section-title mb20">
                                        <i class="fa fa-piggy-bank mr10"></i>{__("Your Points Balance")}
                                    </div>
                                ...
                                <form class="js_ajax-forms" data-url="users/withdraw.php?type=funding">
                                    <div class="form-group form-row">
                                        ...
                                        <div class="col-md-9">
                                            <h6>
                                                <span class="badge badge-lg badge-info">
                                                    {$system['system_currency_symbol']}{$user->_data['user_funding_balance']|number_format:2}
                                                </span>
                                            </h6>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group form-row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="amount">
                                            <span class="form-text">
                                                {__("The minimum withdrawal request amount is")} {$system['system_currency_symbol']}{$system['funding_min_withdrawal']}
                                            </span>
                                        </div>
                                    </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {if $transfer['handle'] == "packages"}
                                                            {__($transfer['package_name'])} {__("Package")} = <strong>{$system['system_currency_symbol']}{$transfer['package_price']}</strong>
                                                        ...
                                                        {elseif $transfer['handle'] == "donate"}
                                                            {__("Funding Donation")} = <strong>{$system['system_currency_symbol']}{$transfer['price']}</strong>
                                                        {/if}
                                                    </td>
                                                    <td>
